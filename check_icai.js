// check_icai.js — TEMPORARY TEST VERSION
...
      process.exit(0);
    } else {
      // >>> TEMPORARY CHANGE: Send a test message on no seats found <<<
      const test_msg = 'ICAI Monitor Test: Script ran successfully but found no seats. Your Telegram setup is WORKING!';
      
...
          method: 'POST',
          headers: {'content-type':'application/json'},
          body: JSON.stringify({ chat_id: TELEGRAM_CHAT_ID, text: test_msg })
        });
      }
